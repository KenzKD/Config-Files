...
class MeshCut(bpy.types.Operator):
    ...
    def execute(self, context):
        ...
        if cutters:
            ...
            # always flatten the cutter
            flatten(cutter, dg)

            # optionally flatten the target
            ...
            # knife intersect, and separete the pieces, which will allow us to find and mark the new edges
            ...
            # remove face selection layer, it's no longer needed now, keep the meshcut layer though
